...
public class SquareDigitNumbersTest {
	...
	@Test
	public void test01() {
		int result = number.getNumber(0, 4);
	...
	@Test
	public void test02() {
		int result = number.getNumber(5, 4);
		System.out.println("result = "+result);
	...
	@Test
	public void test03() {
		int result = number.getNumber(16, 4);
		System.out.println("result = "+result);
	...
	@Test
	public void test04() {
		int result = number.getNumber(121, 4);
		System.out.println("result = "+result);
	...
	@Test
	public void test05() {
		int result = number.getNumber(123, 4);
		System.out.println("result = "+result);
